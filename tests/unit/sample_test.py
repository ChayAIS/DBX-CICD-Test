from dbx_cicd_template_test.tasks.sample_etl_task import SampleETLTask
from dbx_cicd_template_test.tasks.sample_ml_task import SampleMLTask
...
def test_jobs(spark: SparkSession, tmp_path: Path):
    ...
    test_ml_config = {
        "input": common_config,
        "experiment": "/Shared/DBX-CICD-Template-Test/sample_experiment"
    }
